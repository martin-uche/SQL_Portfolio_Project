...
/* 
4. In Order to access the liability of a data breach, we will need you to provide a count of all customers
...
/* 
5. We are interested in how diverse your film offering is as a means of understanding how likely you are to keep
customers engaged in the future. Please provide a count of unique film titles you have in inventory at each store
...
identification values, with a count of rentals they have made all-time, with your highest volume customers at the 
top of the list
*/
...
/* My partner and I want to come by each of the stores in person and meet the manager. Please send over the 
manager's names at each store, with the full address of each property (street address, district, city and country)*/
...
Please pull together a list of each inventory items you have stocked, including the store_id number, the 
...
see the number of films, as well as the average replacement cost, and total replacement cost, sliced by store and 
film category*/
...
customer names, which store they go to, whether or not they are currently active, and their full addresses- street
...
/* We would like to understand how much your customers are spending with you and also to know who your most valuable
customers are. Please pull together a list of customer names, their total lifetime rentals, and the sum of all
payments you have collected from them. It would be great to see this ordered on total lifetime value, with the
...
provide a list of advisor and investor names in one table? could you please note whether they are an investor or an
advisor, and for the investors, it would be good to include which company they work with*/
...
/*
 We are interested in how well you have covered the most-awarded actors. Of all the actors with three types of 
